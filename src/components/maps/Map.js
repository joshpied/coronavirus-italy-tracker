          ...
          regions: {
            ...
            features: data.regional_stats.map(region => ({
              ...
              properties: {
                ...
                description: `<br/><h5>${region.denominazione_regione}</h5><h6>Total Cases: ${region.totale_attualmente_positivi}</h6> <h6>Deceased: ${region.deceduti}</h6> <h6>Recovered: ${region.dimessi_guariti}</h6>`,
